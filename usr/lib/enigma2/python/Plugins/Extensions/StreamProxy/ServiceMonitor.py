...
try:
    ...
    enhanced_log(
        "TVTap WMS Manager not available: %s" %
...
try:
    ...
    def is_proxy_esterno_attivo():
        return False
    enhanced_log(
        "External proxy not available in ServiceMonitor",
        "WARNING",
        "ServiceMonitor")
...
try:
    ...
    def is_freeshot_link(*args, **kwargs):
        return False
    enhanced_log(
        "Freeshot Extractor not available: %s" %
        e, "WARNING", "ServiceMonitor")
...
class StreamProxyServiceMonitor:
                    ...
                    if root:
                        ...
                        if services:
                            ...
                            if found:
                                ...
                                enhanced_log(
                                    "Channel not found, keeping current position", "WARNING")

                except Exception as e:
                    enhanced_log(
                        "Error during channel search: %s" %
                        e, "WARNING")
        ...
        try:
            ...
            if self._is_proxy_ref_string(ref_str):
                ...
                if original_url:
                    ...
                    enhanced_log(
                        "[SERVICEMONITOR] Proxy from external plugin without original URL",
                        "WARNING")
                    self.proxy_active = True
            ...
            if self._is_already_proxy_url(clean_url):
                ...
                if original_url:
                    ...
                    enhanced_log(
                        "[SERVICEMONITOR] Unable to extract URL, passthrough",
                        "WARNING")
                    self.proxy_active = True
                    self.last_original_ref = ref
            ...
            if EXTERNAL_PROXY_AVAILABLE and is_proxy_esterno_attivo() and (
                ...
                # Continue to proxy URL creation
                pass
            ...
            if any(
                ...
                try:
                    ...
                    enhanced_log(
                        "[SERVICEMONITOR] Error clearing VIX cache: %s" %
                        e, "WARNING")
            ...
            # DADDY - clear only local stream cache (NOT DLHD cache)
                ...
                try:
                    ...
                    enhanced_log(
                        "[SERVICEMONITOR] Error clearing cache: %s" %
                        e, "WARNING")
            ...
            # VAVOO - aggressive clearing
                ...
                try:
                    ...
                    enhanced_log(
                        "[SERVICEMONITOR] Error clearing VAVOO cache: %s" %
                        e, "WARNING")
            ...
            # DLHD
                ...
                try:
                    ...
                    enhanced_log(
                        "[SERVICEMONITOR] Error clearing DLHD cache: %s" %
                        e, "WARNING")
            ...
            # NEWKSO
                ...
                try:
                    ...
                    enhanced_log(
                        "[SERVICEMONITOR] Error clearing NEWKSO cache: %s" %
                        e, "WARNING")
                    ...
                    try:
                        ...
                        if resolved_freeshot and resolved_freeshot.get(
                            ...
                            try:
                                ...
                                enhanced_log(
                                    "[SERVICEMONITOR] Error clearing Freeshot cache: %s" %
                                    cache_e, "WARNING")
    ...
    def _detect_playservice_signature(self):
        ...
        try:
            ...
            enhanced_log(
                "[SERVICEMONITOR] Fallback to standard Enigma2 configuration: %s" %
                e, "WARNING")
    ...
    def _clear_ts_cache(self):
        ...
        try:
            ...
            enhanced_log(
                "[SERVICEMONITOR] Error clearing TS cache: %s" %
                e, "DEBUG")
    ...
    def _set_current_selection_alternative(self, proxy_ref):
        ...
        try:
            ...
            enhanced_log(
                "[SERVICEMONITOR] Error setCurrentSelectionAlternative: %s" %
                e, "DEBUG")
